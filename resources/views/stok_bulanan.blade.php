            ...
            <tr>
                <td class="report-content-cell">
                    ...
                    <div style="text-align: left;">
                        ITEM MENU : <?= strtoupper($bahan->nama_bahan) ?>
                    </div>
                    <div style="text-align: left;">
                        PERIODE : <?= strtoupper(date('F Y', strtotime($tanggal))) ?>
                    </div>
                        ...
                        <tbody style="margin-top: 5px ; ">
                            ...
                            foreach ($result as $key => $data) { ?>
                                <tr style="padding-bottom: 5px ; border-bottom: 1px dashed">
                                    ...
                                    <td style="text-align: right;"><?= $bahan->unit ?></td>
                                    <td style="text-align: right;"><?= number_format((float) $data->Incoming, 0, ',', '.') ?></td>
                                    <td style="text-align: right;"><?= number_format((float) $data->Remaining, 0, ',', '.') ?></td>
                                    <td style="text-align: right;"><?= number_format((float) $data->Waste, 0, ',', '.') ?></td>
                                </tr>
                            <?php }
                            ?>
                        </tbody>
